    ...
    return (
        <div className='flex flex-col justify-center items-center w-full py-[100px] text-[#1c4571] dark:text-gray-50'>
            <div className='text-[40px] md:text-[50px] lg:text-[72px] xl:text-[75px] 2xl:text-[78px] w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] text-center'>
                <span className='pr-2'>We</span>
                <img className='w-[43px] h-[58px] md:w-[53px] md:h-[68px] lg:w-[63px] lg:h-[78px] rounded-md object-cover inline-block hover:scale-[1.5] lg:hover:scale-[2] hover:-rotate-3 transition-all duration-500' src='/assets/images/1.webp' />
                <span className='px-2'>create visuals that</span>
                <img className='w-[43px] h-[58px] md:w-[53px] md:h-[68px] lg:w-[63px] lg:h-[78px] rounded-md object-cover inline-block hover:scale-[1.5] lg:hover:scale-[2] hover:rotate-6 transition-all duration-500' src='/assets/images/2.webp' />
                <span className='pl-2'>make you stop and gaze</span>
                ...
                <img className='w-[93px] h-[58px] md:w-[103px] md:h-[68px] lg:w-[113px] lg:h-[78px] rounded-md object-cover inline-block hover:scale-[1.5] lg:hover:scale-[2] hover:-rotate-3 transition-all duration-500' src='/assets/images/0.webp' />
            </div>
